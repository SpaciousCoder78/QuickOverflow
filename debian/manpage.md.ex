% quickoverflow(SECTION) | User Commands
%
% "June 21 2025"
...
quickoverflow - program to do something

# SYNOPSIS

**quickoverflow** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**quickoverflow** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **quickoverflow** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**quickoverflow** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    quickoverflow. See **foo.conf**(5) for further details.
...
**quickoverflow** provides some return codes, that can be used in scripts:
